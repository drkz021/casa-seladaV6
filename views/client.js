...
socket.on('ph_value', (arg) => {
    ...
    if (arg<=5.5) {
        ph_Value.style.color = '#ffa500';
        document.querySelector('.fa-thermometer').style.color = '#ffa500';
        document.getElementById("phStatus").innerHTML = "Normal";
        document.getElementById("phStatus").style.color ="#ffa500";
    } else if (arg>5.5 && arg<6.1){
...
socket.on('ec_value', (arg) => {
    ...
    if (arg<=1.4) {
        ec_Value.style.color = '#ffa500';
        document.querySelector('.fa-vials').style.color = '#ffa500';
        document.getElementById("ecStatus").innerHTML = "Moderate";
        document.getElementById("ecStatus").style.color ="#ffa500";
    } else if (arg>1.4 && arg<1.8) {
